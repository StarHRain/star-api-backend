...
public interface RedisConstant {
     ...
     * 接口查询（分页
     */
    String INTERFACE_QUERY_KEY = "admin:interfaceInfo:query:current:";
    Long INTERFACE_QUERY_TTL = 60L;
    String LOCK_INTERFACE_PAGE = "admin:interfaceInfo:query:lock:current:";
