...
public class BigModelCharConfig extends WebSocketListener {
    ...
    public static final String appid = "725adaa4";
    public static final String apiSecret = "N2YwOWFkYTJhNzA0NWFhMmQ2ZGQ4NmEx";
    public static final String apiKey = "bab8ee727dbf7b91947298dfb690e184";
    ...
    public BigModelCharConfig() {
    }

    // 构造函数
    public BigModelCharConfig(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
        this.wsCloseFlag = wsCloseFlag;
    }

    public BigModelCharConfig(long questionId, RedissonClient redissonClient) {
    ...
    public void getResult(String newQuestion) {
        try {
            ...
            for (int i = 0; i < 1; i++) {
                totalAnswer = "";
                WebSocket webSocket = client.newWebSocket(request, new BigModelCharConfig(i + "",
                        false));
            }
